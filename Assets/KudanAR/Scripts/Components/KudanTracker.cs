...
namespace Kudan.AR
{
	...
	public class KudanTracker : MonoBehaviour
	{
		...
		//		public Text _camPos;
		//
		//		public Text _floorPositionText;
...
//					DontDestroyOnLoad(gameObject);
		...
		public void FloorPlaceGetPose(out Vector3 position, out Quaternion orientation)
		{
			...
			//			_floorPositionText.text = "floor Pos: " + position;
		}
		...
		void Update()
		{
			if (_trackerPlugin != null)
			{
				...
				//				camPos.text = "Cam: Pos" + renderingCamera.transform.position + "; Rot" + renderingCamera.transform.rotation;
				//				camPos.text = "Cam: Pos";
